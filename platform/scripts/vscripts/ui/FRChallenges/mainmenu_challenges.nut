...
void function OpenFRChallengesMainMenu(int dummiesKilled)
{
	...
	Hud_SetText(Hud_GetChild( file.menu, "DummiesKilledCounter"), "当前已击杀假人: " + dummiesKilled.tostring() + " (退出重置计数)")
	if(PlayerCurrentWeapon == "") 
		Hud_SetText(Hud_GetChild( file.menu, "CurrentWeapon"), "当前武器: Wingman")
	else
