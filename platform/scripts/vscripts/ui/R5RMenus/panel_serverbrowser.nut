...
void function InitR5RServerBrowserPanel( var panel )
{
	...
	Hud_SetText( Hud_GetChild( file.panel, "PlayersCount"), "在线玩家: 0")
	Hud_SetText( Hud_GetChild( file.panel, "ServersCount"), "可用服务器: 0")
	Hud_SetText (Hud_GetChild( file.panel, "Pages" ), "  页数: 0/0  ")
...
void function ServerBrowser_FilterServerList(string filter)
{
	...
	// Set UI Labels
	Hud_SetText( Hud_GetChild( file.panel, "PlayersCount"), "在线玩家: " + m_vAllPlayers)
	Hud_SetText( Hud_GetChild( file.panel, "ServersCount"), "可用服务器: " + m_vServerList.len())
	Hud_SetText (Hud_GetChild( file.panel, "Pages" ), "  页数: 1/" + (m_vPages.pAmount + 1) + "  ")
}
...
void function ServerBrowser_RefreshServerListing(bool refresh = true)
{
	...
	// Set UI Labels
	Hud_SetText( Hud_GetChild( file.panel, "PlayersCount"), "在线玩家: " + m_vAllPlayers)
	Hud_SetText( Hud_GetChild( file.panel, "ServersCount"), "可用服务器: " + svServerCount)
	Hud_SetText (Hud_GetChild( file.panel, "Pages" ), "  页数: 1/" + (m_vPages.pAmount + 1) + "  ")
...
void function ServerBrowser_SelectServer(int id, string name, string map, string playlist, string desc)
{
	...
	Hud_SetText(Hud_GetChild( file.panel, "ServerCurrentPlaylist" ), "当前模式" )
	Hud_SetText(Hud_GetChild( file.panel, "ServerCurrentMap" ), "当前地图" )
