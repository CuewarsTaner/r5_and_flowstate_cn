"scripts/resource/ui/menus/R5R/panels/home.res"
{
	...
	"Info"
	{
		...
		"labelText"				"R5R允许你使用MOD加载原生Apex，通过运行特定服务器、特定游戏模式的脚本来创建在线服务器，并允许你DIY自己的游戏模式、地图、武器以及更多内容。"
		"font"					"DefaultBold_41"
		"allcaps"				"0"
	...
	"Info2"
	{
		...
		"fontHeight"			"25"
		"textAlignment"			"north-west"
		"labelText"				"Flowstate脚本基于Apex R5R 社区服。脚本修复了许多BUG，并新增了许多新功能。Flowstate脚本还包含了特别内容，例如社区制作的新技能、新模式和新地图！" 
		"font"					"DefaultBold_41"
		"allcaps"				"0"
		"fgcolor_override"		"200 200 200 255"

		"pin_to_sibling"		"Welcome2"
		"pin_corner_to_sibling"	"TOP_LEFT"
		"pin_to_sibling_corner"	"BOTTOM_LEFT"
	}
	...
	"CNDepotLine1"
	{
		...
		"fontHeight"			"25"
		"textAlignment"			"north-west"
		"labelText"				"当前版本：CN Depot V20221003（Depot v2.2）"
		"font"					"DefaultBold_41"
		"allcaps"				"0"
		"fgcolor_override"		"200 200 200 255"
	...
	"CNDepotLine2"
	{
		...
		"fontHeight"			"25"
		"textAlignment"			"north-west"
		"labelText"				"KOOK频道ID：98171075（协助/更新/建议/反馈/开服）"
		"font"					"DefaultBold_41"
		"allcaps"				"0"
		"fgcolor_override"		"200 200 200 255"
